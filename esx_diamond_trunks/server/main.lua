--[[
	...
	This script has nothing to do with ESX-org's vehicle inventory This Is My Own Workk.
...
RegisterServerEvent('esx_vehicletrunk:giveBlackmoney')
AddEventHandler('esx_vehicletrunk:Blackmoney', function(weapon)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.addWeapon(weapon, Config.Ammo)
end)
